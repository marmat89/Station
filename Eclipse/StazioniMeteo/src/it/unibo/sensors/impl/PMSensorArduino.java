 ...
 *
 */
public class PMSensorArduino extends SensorArduino {
	 ...
	 * @param deb
	 */
	public PMSensorArduino(String name, String type, String UOM, OnBoardDebugger deb) {
	 ...
	 * @param type
	 */
	public PMSensorArduino(String name, String type, String UOM) {
		super(name, type, UOM);			
	}
	...
	public static void main(String[] args) {
		PMSensorArduino testSens = new PMSensorArduino("DSM501A", "PM_","cfp");
