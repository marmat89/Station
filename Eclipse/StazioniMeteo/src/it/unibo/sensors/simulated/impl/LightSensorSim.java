 ...
 * @version 1.0.0
 * @since 06/feb/2015 01:06:55
 *
 */
public class LightSensorSim extends SensorSim {
	public LightSensorSim(String name, String type) {
		super(name, type);
	}
	...
	public static void main(String[] args) {
		LightSensorSim testSens = new LightSensorSim("LDRGL5528", "LGH");
