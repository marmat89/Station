 ...
 * @version 1.0.0
 * @since 06/feb/2015 01:02:22
 *
 */
public class RainSensorSim extends SensorSim {
	public RainSensorSim(String name, String type) {
		super(name, type);
	}
	...
	public static void main(String[] args) {
		RainSensorSim testSens = new RainSensorSim("RAINECO", "RL");
