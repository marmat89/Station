 ...
 *
 */
public class DbCom implements Communicator {
	Connection db;
	private String user;
	...
	/* (non-Javadoc)
	 * @see it.unibo.system.CommunicationNOSQL#sendMes(it.unibo.interfaces.StationRPI, java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.unibo.system.CommunicationNOSQL#turnOffConnection()
	 */
	@Override
